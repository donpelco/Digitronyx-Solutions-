  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6 text-center lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-5 py-2 text-xs font-medium text-foreground dark:bg-card/50 dark:border-border dark:text-muted-foreground">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-primary opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-primary" />
            </span>
            <span className="font-semibold">Hardware Premium</span>
            <span className="text-muted-foreground">&</span>
            <span className="font-semibold">Soporte IT Profesional</span>
          </div>
        </motion.div>
